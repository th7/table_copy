module TableCopy
  module PG
    class Destination
      attr_reader :table_name, :conn_method, :indexes, :fields_proc, :primary_key, :sequence_field, :after_create, :soft_delete_field
      ...
      def initialize(args)
        ...
        @fields_proc       = args[:fields_proc] || Proc.new { args[:fields] }
